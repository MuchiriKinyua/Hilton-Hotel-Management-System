...
<div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
                ...
                <li>
                <a href="#housekeepingDropdown" aria-expanded="false" data-toggle="collapse"> 
                <i class="icon-windows"></i>Housekeeping
                </a>
                <ul id="housekeepingDropdown" class="collapse list-unstyled">
                  <li><a href="{{url('create_housekeeping')}}">Create Housekeeping</a></li>
                  <li><a href="{{url('view_housekeeping')}}">View Housekeeping</a></li>
                </ul>
                </li>
                <li>
